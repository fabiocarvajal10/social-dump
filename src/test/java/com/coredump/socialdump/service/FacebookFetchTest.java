...
public class FacebookFetchTest {
  ...
  @Inject
  private FacebookFetch facebookFetch;

  @Inject
  private SearchCriteriaRepository searchCriteriaRepository;

  @Test
  public void assertThatFetcherGetsPosts() {
    facebookFetch.setSearchCriteria(searchCriteriaRepository
      .findAllBySearchCriteria("Cinnamon").get(0));
    facebookFetch.init();
    assertThat(facebookFetch.fetch().size()).isGreaterThan(0);
  }
/*
  @Test
