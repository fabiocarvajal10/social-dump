...
angular.module('socialdumpApp')
    .controller('EventController', function ($scope, Event, Organization, EventStatus, EventType, SearchCriteria, TemporalAccess, ParseLinks) {
        $scope.events = [];
        ...
        $scope.clear = function () {
            $scope.event = {startDate: null, endDate: null, description: null, activatedAt: null, postDelay: null, id: null};
