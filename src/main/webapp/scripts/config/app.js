...
angular.module('socialdumpApp', [ 'ngAnimate',
    ...
    'ngCacheBuster', 'infinite-scroll', 'ui.grid', 'ui.bootstrap', 'ui.bootstrap.datetimepicker', 'ui.utils',
    'ui.load', 'ui.jq', 'ui.select', 'oc.lazyLoad', 'pascalprecht.translate', 'ngMaterial',
    'ui.date', 'socialdumpApp.monitors', 'socialdumpApp.temporalAccess', 'socialdumpApp.access'
